...
#   2. benchmark_isbs.py x 4      SPA (needs .venv-spa), sigconfide at defaults,
#                                 sigconfide with SBS1/SBS5 forced, and the same
#                                 with the over-dispersed bootstrap (sigma 0.10);
#                                 restricted and full ground truth,
#                                 clean/noise5/noise10
...
# about 35 minutes on 14 cores.  Pass --seed N and/or --out-dir DIR to build
...
$PY benchmark_isbs.py --benchmark-dir "$DIR" --label sc_mandatory --mandatory SBS1 SBS5 \
    --ground-truth restricted full --append
$PY benchmark_isbs.py --benchmark-dir "$DIR" --label scm_od010 --mandatory SBS1 SBS5 \
    --overdispersion 0.10 --ground-truth restricted full --append
